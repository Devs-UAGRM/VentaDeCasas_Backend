...
const precio_1 = __importDefault(require("../../models/mod_casas/precio"));
const bitacora_1 = require("../mod_user/bitacora");
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const obj = yield precio_1.default.findAll();
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const obj = yield precio_1.default.findByPk(id);
    if (obj) {
        yield (0, bitacora_1.saveBitacora)({
            token: req.header('token'),
...
const post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    try {
        const obj = new precio_1.default(body);
        yield obj.save();
        yield (0, bitacora_1.saveBitacora)({
            token: req.header('token'),
