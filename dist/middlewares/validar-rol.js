...
exports.isUserRole = exports.isSalesRole = exports.haveRole = exports.isAdminRole = void 0;
const rol_1 = __importDefault(require("../models/mod_user/rol"));
const isRol = (id_rol) => __awaiter(void 0, void 0, void 0, function* () {
    if (id_rol) {
        const rol = yield rol_1.default.findByPk(id_rol);
        if (rol) {
            return rol.rol;
        }
    }
...
const isSalesRole = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        return res.status(500).json({
            msg: 'Se quiere validar el token primero antes de verificar el role',
        });
